...
// 目标网页 URL
$url = 'https://meeting.tencent.com/web-service/query-download-info?q=[{"package-type":"app","channel":"0300000000","platform":"windows","arch":"x86_64"}]&nonce=AAAAAAAAAAAAAAAA';
if (isset($_GET['x86'])) {
...
// 获取下载地址
$downloadUrl = $jsonResponse['info-list'][0]['url'];
